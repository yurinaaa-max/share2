        ...
        <div class="col-lg-8">
          ...
          <div class="course_tabs_container">
            <div class="tab_panels">
              <!-- Description -->
              <div class="tab_panel">
                <div class="tab_panel_title"><?php echo $catname; ?></div><!-- 変える -->
                      ...
                      <div class="row">
                        <div class="col-lg-10 col-md-10 col-sx-12">
                          <div class="news_post_small_header">
                            <img src="<?php echo get_template_directory_uri();?>/images/tags-solid.png" alt="" /> <?php echo $catname; ?><!-- 追加 -->
                          </div>
                          ...
                          <div class="news_time">
                            <div>
                              <span>卒業生:<?php echo post_custom('graduate_year') ;?></span>
                            </div>
                          </div>
